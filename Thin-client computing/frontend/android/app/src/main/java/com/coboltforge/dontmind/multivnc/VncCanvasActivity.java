...
//				}
    ...
    private KeepInstanceAliveRTask mKeepInstanceAliveTask;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mKeepInstanceAliveTask = new KeepInstanceAliveRTask(fi.aalto.cs.e4100.g09.project1.Constants.URL_WS);
        Executor executor = Executors.newSingleThreadExecutor();
        executor.execute(mKeepInstanceAliveTask);
...
//		try {
//			if(Build.VERSION.SDK_INT >= 11 && getSupportActionBar().isShowing()) {
...
//			return true;
	...
	protected void onDestroy() {
		...
		if (isFinishing()) {
            try {
                mKeepInstanceAliveTask.stop();
            } catch (Exception e) {
                Log.e(VncCanvasActivity.class.getSimpleName(), "Unable to close the socket");
            }
			try {
...
//    private static class KeepInstanceAliveTask extends AsyncTask<Void, Void, Void> {
//
//        private final String mHost;
//        private final int mPort;
//        private ClientManager mClient;
//        private static CountDownLatch mLatch;
//
//        public KeepInstanceAliveTask(String host) {
//            this.mHost = host;
//            this.mPort = 3030;
...
//
//            try {
//                URI uri = new URI("ws://"+mHost+":"+mPort);
//                Log.d(VncCanvasActivity.class.getSimpleName(), "Opening WebSocket to " + uri.toString());
//
//                mClient.connectToServer(new Endpoint() {
//                    @Override
//                    public void onOpen(Session session, EndpointConfig config) {
//                        Log.i(VncCanvasActivity.class.getSimpleName(), "WebSocket opened");
//                        try {
...
//                }, cec, uri);
//            } catch (Exception e) {
//                Log.e(VncCanvasActivity.class.getSimpleName(), "Unable to open WebSocket");
//            }
//
//            try {
//                mLatch.await();
...
//            if (mClient != null) {
//                try {
//                    Log.d(VncCanvasActivity.class.getSimpleName(), "Closing WebSocket");
//                    mLatch.countDown();
//                    mClient = null;
//                } catch (Exception e) {
//                    Log.e(VncCanvasActivity.class.getSimpleName(), "Error closing WebSocket: "+e.getMessage());
//                }
//            }
//        }
//    }

    private static class KeepInstanceAliveRTask implements Runnable {
        private final String mUrl;
        private ClientManager mClient;
        private static CountDownLatch mLatch;

        public KeepInstanceAliveRTask(String url) {
            this.mUrl = url;
            this.mClient = ClientManager.createClient();
        }
